...
concat: {
    basic_and_extras: {
      files: {
        ...
        'css/src/main.scss': ['css/src/reset.scss', 'css/src/styles.scss', 'css/src/variables.scss'],
        'js/build/main.js': ['js/src/script.js', 'js/src/slider/js', 'js/src/img_module.js'],
